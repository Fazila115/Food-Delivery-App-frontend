        ...
        <div className='w-full h-[120px] p-2 shadow-lg flex justify-between'>
            <div className='w-[60%] h-full flex gap-5'>
                ...
                <div className='w-[40%] h-full flex flex-col gap-5'>
                    ...
                    <div className='w-[110px] h-[50px] bg-slate-400 flex rounded-lg overflow-hidden border-2 border-green-400 text-xl'>
            ...
            <div className='flex flex-col justify-start items-end gap-6'>
                <span className='text-xl text-green-400 font-semibold'>Rs 400/-</span>
                <RiDeleteBinLine className='w-[30px] h-[30px] text-red-400 ' />
            </div>
        </div>
    )
}
